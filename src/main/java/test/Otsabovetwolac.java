...
//		Thread.sleep(5000);
		...
		dateofestablishment.sendKeys("01-07-2024");
		...
		dateoffirstsanction.sendKeys("29-07-2024");
	    ...
	    dateoflastrenewal.sendKeys("29-07-2024");
...
// 	    Thread.sleep(2000);
	  ...
	  //draft section to be 
        ...
        cutoffdate.sendKeys("29-07-2024");
        ...
        WebElement dropdownElement = driver.findElement(By.xpath("//select[@id='DrpOTSPartnerAcNo']")); // Replace with your dropdown locator
...
//        accountnoSelect.selectByVisibleText("1000012566666");
	   ...
	   //creadit facilities page 5
	    ...
	    dateofloan.sendKeys("30-07-2024");
	    ...
	    ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView({block: 'nearest', inline: 'start'});", dateofclassifieing);
	    dateofclassifieing.sendKeys("30-07-2024");
	    ...
	    WebElement recovorytill=  wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtRecoveryTillChanging_1000012566666']")));
	    recovorytill.sendKeys("4545654");
	    WebElement recovoryafter= driver.findElement(By.xpath("//input[@id='TxtRecoveryAfterChanging_1000012566666']"));
	    recovoryafter.sendKeys("435354");
	    WebElement totalrecovery= driver.findElement(By.xpath("//input[@id='TxtTotalRecovery_1000012566666']"));
	    totalrecovery.sendKeys("43344");
	    WebElement dateoflastpayment= driver.findElement(By.xpath("//input[@id='TxtDateOfLastPayment_1000012566666']"));
	    dateoflastpayment.sendKeys("30-07-2024");
	    WebElement amtoflastpayment = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtAmountofLastPayment_1000012566666']")));
	    ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView({block: 'nearest', inline: 'start'});", amtoflastpayment);
	    dateofclassifieing.sendKeys("655677576");
	    WebElement intrestsuspense=  wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtInterestSuspenseReversed_1000012566666']")));
	    intrestsuspense.sendKeys("22");
	    WebElement suitexpenses1=  wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtSuitExpensesDebited_1000012566666']")));
	    suitexpenses1.sendKeys("44345345");
	    WebElement otherexpenses = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtOtherExpensesdebited_1000012566666']")));
	    ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView({block: 'nearest', inline: 'start'});", otherexpenses);
	    dateofclassifieing.sendKeys("655677576");
	    ...
	    WebElement reasonsifnot = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtReasonsIfNot_1000012566666']")));
	    reasonsifnot.sendKeys("reason");
	    WebElement relavantdate = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtRelevantDate1000012566666_']")));
	    relavantdate.sendKeys("20-07-2024");
	    WebElement liablityason = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtRelevantDateLiability_1000012566666']")));
	    liablityason.sendKeys("30-07-2024");
	    WebElement dateofclaim = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtClaimDate_1000012566666']")));
	    dateofclaim.sendKeys("30-07-2024");
	    WebElement amountofclaim = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtAmtClaimPreffered_1000012566666']")));
	    amountofclaim.sendKeys("665676");
	    WebElement dateofclaimsettled = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtClaimAmtSettledDate_1000012566666']")));
	    dateofclaimsettled.sendKeys("30-07-2024");
	    WebElement amountofclaimsettled = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtClaimAmtSettled_1000012566666']")));
	    amountofclaimsettled.sendKeys("4656565");
	    WebElement presentbalance = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtPresentbalance_1000012566666']")));
	    presentbalance.sendKeys("6678575");
	    WebElement specifyreasons = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtReasonClaim_1000012566666']")));
	    specifyreasons.sendKeys("ererrv");
	    WebElement ECGCclaimamount = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtECGCClaimAmt_1000012566666']")));
	    ECGCclaimamount.sendKeys("4455465");
	    WebElement noteligiblereason = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtWhetherEligiblereasons_1000012566666']")));
	    ...
	    dateofwindingup.sendKeys("30-07-2024");
        ...
        dateofclaim1.sendKeys("30-07-2024");
        ...
        dateoflegalnotice.sendKeys("30-07-2024");
        ...
        dateoffilingsuit.sendKeys("30-07-2024");
        ...
        appealdate.sendKeys("30-07-2024");
	    ...
	    WebElement whethersuitisfiled = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//body[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[10]/div[6]/div[1]/table[1]/tbody[1]/tr[1]/td[3]/label[1]/span[1]")));
	    whethersuitisfiled.click();
	    WebElement dateofauction= wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='TxtOTSAuctionDate']")));
	    dateofauction.sendKeys("30-07-2024");
        ...
        dateofinvestigation.sendKeys("30-07-2024");
	    ...
	    WebElement circleoff = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//select[@id='DrpOTSstafflapses']")));
        ...
        officenotedated.sendKeys("30-07-2024");
