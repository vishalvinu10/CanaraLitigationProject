...
//	        driver.get("https://safallitigation.onlinesafe.in/");
	      ...
	      //approval
	        ...
	        WebElement Pushback = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@id='BtnComRevert']")));
	        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", Pushback);       
	        js11111.executeScript("arguments[0].click();", Pushback);
...
//	        Thread.sleep(2000);
	        ...
	        casestatusSelect.selectByVisibleText("Pushback");
	        ...
	        if (selectedCaseNumber.equals(selectedCaseNumber1)) {
	            System.out.println("Success: The case number pushbacked matches the case number in pushback/pending list which is " + selectedCaseNumber);
	        } else {
	            System.out.println("Error: The case number pushbacked does not match the case number in pushback/pending.");
	        }
