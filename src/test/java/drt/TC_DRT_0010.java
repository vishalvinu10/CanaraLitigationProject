	...
	public class drtcaseadd {
		 ...
		 private WebDriverWait wait;
		    ...
		    public void testAdddrtcase() throws InterruptedException {
	            ...
	            descriptionElement.sendKeys("CASE APPROVED VIA BM");
	            
	            
	            WebElement approvebutton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@id='BtnDRTApprove']")));
	            approvebutton.click();
	            Thread.sleep(2000);
	            ...
	            if (approvebutton != null) {
	            	...
	            	System.out.println("case approved by BM");
