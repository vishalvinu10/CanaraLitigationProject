...
//	     	driver.get("https://safallitigation.onlinesafe.in/");
          ...
          //case stage
	        ...
	        js.executeScript("document.getElementById('TxtComFilingDate').value='28-08-2024'");
...
//	        DateofFiling.sendKeys("06-08-2024");
 ...
 @Test(priority=2)
 public void commercialfetchtest() throws InterruptedException {
// 	driver.get("https://safallitigation.onlinesafe.in/");
 	 driver.get("http://192.168.0.137:8955/");
    ...
    JavascriptExecutor js = (JavascriptExecutor) driver;
    WebElement clickapprovalsElement = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[1]/div[1]/nav[1]/div[2]/ul[1]/li[4]/a[1]/span[2]")));
    js.executeScript("arguments[0].click();", clickapprovalsElement);
    
    JavascriptExecutor js1 = (JavascriptExecutor) driver;
    WebElement clickapprovals = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[@data-i18n='nav.basic-components.main'][normalize-space()='Approvals']//following::span[normalize-space()='Approval']")));
    js1.executeScript("arguments[0].click();", clickapprovals);
      ...
      js11.executeScript("arguments[0].click();", search);
      
	 
	 WebElement casenoElement = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//tbody/tr[1]/td[4]")));

    if (casenoElement.getText().equals(String.valueOf(randomcaseno))) {  //converted "randomcaseno" which was int to string
        System.out.println(" 3) case number matches the added case: " + randomcaseno);
    } else {
        System.out.println(" 3) case Number does not match the added case. Expected: " + randomcaseno + " but found: " + casenoElement.getText());
    }
