...
public class TC_CC_004 {
	...
	public class commercial {
	 ...
	 private WebDriverWait wait;
	    ...
	    String suitamount = RandomString(15);
	    String randomInterest = generateRandomInterest(); 
	    String randomMediation = RandomString(50);
	    String randomcaseno = RandomString(50);
...
//	     	driver.get("https://safallitigation.onlinesafe.in/");
          ...
          //case stage
	        ...
	        DateofFiling.sendKeys(dateoffiling);
	     ...
	     // ANSI escape code for green text
           ...
           System.out.println(greenColor + "Commercial Case added successfully with maxlength " + resetColor);
